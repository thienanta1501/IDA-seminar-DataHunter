...
def generate_html_report(
    ...
    Args:
        data_source: Path to data file (csv/excel) or a pandas DataFrame.
        output_html_file: Name of the HTML file to save the report.
    ...
    """
    print(f"Starting report generation for: {output_html_file}")
