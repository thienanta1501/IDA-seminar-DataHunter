...
class ScatterChart:
    def __init__(self, x, y, s=None, c=None, marker=None, cmap=None, norm=None, vmin=None, vmax=None,
                 alpha=None, linewidths=None, edgecolors=None, colorizer=None, plotnonfinite=False, title=None, **kwargs):
        self.x = x
        self.y = y
        self.s = s
        ...
        self.colorizer = colorizer  # We can use this for additional colorizing logic
